...
class inferThread(threading.Thread):
    def __init__(self, yolov7_wrapper, path_video, name):
        threading.Thread.__init__(self)
...
def load_tensorrt_plugin(device_idx=None) -> bool:
    ...
    """
    lib_path = "build/libmyplugins.so"
    success = False
...
if __name__ == "__main__":
    ...
    try:
        ...
        thread1 = inferThread(yolov7_wrapper, path_video, 1)
        thread2 = inferThread(yolov7_wrapper, path_video, 2)
        thread3 = inferThread(yolov7_wrapper, path_video, 3)
        thread4 = inferThread(yolov7_wrapper, path_video, 4)
        thread5 = inferThread(yolov7_wrapper, path_video, 5)
        thread6 = inferThread(yolov7_wrapper, path_video, 6)
        thread7 = inferThread(yolov7_wrapper, path_video, 7)
        thread8 = inferThread(yolov7_wrapper, path_video, 8)
        thread1.start()
        thread2.start()
        thread3.start()
        thread4.start()
